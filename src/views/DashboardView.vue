...
<nav>
    <div class="wrapper">
        ...
        <ul class="nav-links">
            ...
            <li>
                <router-link v-if="isAdmin" to="/appointments" class="nav-link">Appointment</router-link>
            </li>
            <li>
                <router-link v-if="isAdmin" to="/medicalrecords" class="nav-link">Medical Record</router-link>
            </li>
            <li>
                <router-link v-if="isAdmin" to="/users" class="nav-link">User List</router-link>
            </li>
            <li>
                <router-link v-if="isDoctor" to="/patients" class="nav-link">My Patients</router-link>
            </li>
            <li>
              <router-link v-if="isDoctor || isPatient" to="/appointments" class="nav-link">My Appointments</router-link>
            </li>
            <li>
              <router-link v-if="isDoctor || isPatient" to="/medicalrecords" class="nav-link">My Medical Records</router-link>
            </li>
            <li>
